...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-international" &&
                "${module_path}" != github.com/faustbrian/go-international/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-international"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
